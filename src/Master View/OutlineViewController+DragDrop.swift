...
extension NSPasteboard.PasteboardType {
    ...
    static let nodeRowPasteBoardType =
        NSPasteboard.PasteboardType("org.appel-rockhold.CDOD.internalNodeDragType")
}
...
//                NodePasteboardWriter.UserInfoKeys.name: dragNode.description
//            ]
//            return provider
//        } else {
...
//        if let dropNode = OutlineViewModel.geoObject(from: item as! NSTreeNode) {
